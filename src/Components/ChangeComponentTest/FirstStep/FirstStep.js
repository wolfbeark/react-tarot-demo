    ...
    <>
      <FirstStepContainer>
        <QuestionBox>
          ...
          >
            <label htmlFor="Question_input1">원하시는 숫자를 입력하세요</label>
            <ModeInSelectBox>
              <CustomSelectBox
                onClick={(e) => {
                  e.preventDefault();
            ...
            <QuestionBtn
              ...
              whileHover={
                value.length <= 0 ? DefaultBtnVar.empty : DefaultBtnVar.hover
              }
              whileTap={
                value.length <= 0 ? DefaultBtnVar.empty : DefaultBtnVar.click
              }
              style={
                value.length <= 0
                  ? {
