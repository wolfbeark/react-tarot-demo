...
function DragCardInfo(props) {
    ...
    const [position, setPosition] = useState({ x : 0, y : 0});
     let selectedImgNumArr = props.selectedImgNumArr;
        ...
        <Draggable nodeRef={cardRef} onDrag={(e, data) => {trackPos(data)}}>
            <DragCardContainer
                ...
                imgsrc={isFliped === false 
                    ...
                    : `${process.env.PUBLIC_URL}/images/ArcanaOfCard/DefaultImages/TotalImages/Default${selectedImgNumArr[_count]}.png`
                }
