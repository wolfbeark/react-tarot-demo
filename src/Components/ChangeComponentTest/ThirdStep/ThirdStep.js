...
function QueSelectCard(props) {
  ...
  let { selectedCardControlArr, setSelectedCardControlArr } =
    props.selectCardController;
...
function ThirdStep(props) {
  ...
  let [selectedCardControlArr, setSelectedCardControlArr] = useState(
    new Array(78)
  );
  let selectCardController = {
    selectedCardControlArr,
    setSelectedCardControlArr,
  };
          ...
          <DrawControlBtnBox>
            ...
            <>
              <DrawControlBtn // Auto Btn
                ...
                whileHover={
                  selectCount <= 0 && isCardClicked === false ? "hover" : "none"
                }
                whileTap={
                  selectCount <= 0 && isCardClicked === false ? "click" : "none"
                }
                onTap={(e) => {
                ...
                style={
                  selectCount <= 0 && isCardClicked === false
                    ? {
                        opacity: 1,
              ...
              <DrawControlBtn // Next Btn
                variants={drawControlBtnVariants}
                whileHover={
                  selectCount === userSetNumber && isCardClicked === false
                    ? "hover"
                    : "none"
                }
                whileTap={
