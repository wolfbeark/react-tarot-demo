...
function SpreadComponents() {
  ...
  const _totalSelectedNumArr = useSelector(
    (state) => state.gameManager.totalSelectedNumArr
  );
  const _selectedCardCount = useSelector(
    (state) => state.gameManager.selectedCardCount
  );
  ...
  let [dragCardNumArr, setDragCardNumArr] = useState(
    new Array(_selectedCardCount)
  );
  ...
  const onCaptureHandler = (e) => {
    ...
    html2canvas(document.getElementById("spreadContainer")).then((canvas) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <MainSpreadBox className="spreadZone" ref={mainBox} layoutId="spread">
            <MainSpreadZone
          ...
          <OptionSpreadBox ref={optionBox}>
            <OptionSpreadDeckBox>
              <DeckZone>
                <OptionSpreadDragBox ref={selectedDeckZoneRef}>
                  {/* <>
